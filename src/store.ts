...
function toObserver<T, Ev extends EventObject>(
  nextHandler?: Observer<T, Ev> | ((value: T, event: Ev) => void),
...
>(
  ...
  let observers: Set<Observer<StoreSnapshot<TContext>, StoreEvent>> | undefined;
  ...
  function receive(event: StoreEvent) {
    ...
    observers?.forEach((o) => o.next?.(currentSnapshot, event));
  }
 ...
 * @returns
 */
function createStoreTransition<
  TContext extends StoreContext,
  TEventPayloadMap extends EventPayloadMap
>(
  transitions: {
